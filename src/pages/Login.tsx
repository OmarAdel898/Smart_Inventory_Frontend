  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <input
        ...
        required={required}
        className="w-full h-10 px-3 bg-surface-container rounded-lg border border-outline-variant text-sm text-on-surface outline-none transition-all placeholder:text-on-surface-variant/50 focus:border-accent focus:ring-1 focus:ring-accent"
      />
    </div>
  );
}
      ...
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-navy to-accent p-8 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between h-full">
          ...
          <div className="max-w-sm">
            <h1 className="text-[32px] font-semibold text-white leading-10 tracking-tight mb-4">
              Master Your Enterprise Inventory.
            </h1>
            <p className="text-base text-white/80 leading-6">
              Streamline your supply chain, track assets in real-time, and make
              data-driven decisions with our intelligent inventory management
              platform.
            </p>
          </div>
          <div className="text-xs text-white/60 tracking-wide">
            &copy; 2026 StockSavvy Inc. All rights reserved.
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 lg:p-8 bg-surface">
        <div className="w-full max-w-md">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-on-surface-variant">
              {mode === "login"
                ...
                : "Join 2,000+ companies managing smarter inventory."}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex items-center justify-between mt-1 mb-2">
                <label className="flex items-center gap-2 cursor-pointer group">
                  <div className="relative flex items-center justify-center w-4 h-4 rounded border border-outline-variant group-hover:border-accent transition-colors">
                    <input
                      type="checkbox"
                      className="peer appearance-none w-full h-full rounded cursor-pointer checked:bg-accent checked:border-accent transition-all"
                    />
                    <span className="material-symbols-outlined text-white text-[12px] absolute opacity-0 peer-checked:opacity-100 transition-opacity pointer-events-none select-none">
                      check
                    </span>
                  </div>
            ...
            <Button
              type="submit"
              className="w-full bg-navy hover:bg-navy/90 cursor-pointer"
            >
          ...
          {mode === "login" ? (
            <>
              <div className="relative text-center my-6">
                ...
                <span className="relative bg-surface px-2 text-xs text-on-surface-variant uppercase tracking-wide">
                  Or continue with
                </span>
              </div>
              <div className="flex">
